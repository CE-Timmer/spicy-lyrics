...
const ShaderUniformStructure = new Map();
...
export const DisposeShaderUniforms = (uniforms)=>{
  if (!uniforms) return;
  // Dispose of any textures in the uniforms
  if (uniforms.BlurredCoverArt && uniforms.BlurredCoverArt.value) {
    uniforms.BlurredCoverArt.value.dispose();
    uniforms.BlurredCoverArt.value = undefined;
  }
  if (uniforms.NewBlurredCoverArt && uniforms.NewBlurredCoverArt.value) {
    uniforms.NewBlurredCoverArt.value.dispose();
...
//# sourceMappingURL=DBG_ThreeShaders.js.map
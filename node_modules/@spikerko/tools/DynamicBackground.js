import * as THREE from "@jsr/3d__three";
//import * as THREE from "@3d/three";
import { GetShaderUniforms, VertexShader, FragmentShader, DisposeShaderUniforms } from "./DBG_ThreeShaders.js";
// deno-lint-ignore verbatim-module-syntax
import { Maid } from "@jsr/socali__modules/Maid";
 ...
 */ export class DynamicBackground {
  ...
  /**
    ...
    if (Array.isArray(pluginsInput)) {
      ...
      pluginsObj = Object.assign({}, pluginsInput);
    }
    ...
    const sceneMesh = new THREE.Mesh(this.meshGeometry, meshMaterial);
    ...
    this.maid.Give(()=>{
      if (this.container.renderer) {
        ...
        this.container.renderer = undefined;
      }
    });
  ...
  /**
    ...
    this.renderCamera.position.z = 1;
  ...
  async _performUpdate(options) {
    ...
    if (this.container.uniforms.NewBlurredCoverArt.value) {
      this.container.uniforms.NewBlurredCoverArt.value.dispose();
    }
    // Set the new texture
  ...
  /**
     ...
     */ async initializeTexture(imageCoverUrl, placeholderHueShift = 0) {
  ...
  /**
     ...
     */ animateTransition(newTexture, newCoverArtUrl, oldSpeed) {
  ...
  /**
     ...
     * @param newCoverArtUrl URL of the new cover art
     */ completeTransition(newTexture, newCoverArtUrl) {
  ...
  /**
     ...
     */ async getBlurredCoverArt(coverArtUrl, placeholderHueShift = 0) {
    if (this.blurredCoverArts.has(coverArtUrl)) {
      ...
      if (typeof this.clientOptions?.cacheLimit === "number" && this.blurredCoverArts.size >= this.clientOptions.cacheLimit) {
    ...
    circleCtx.closePath();
    circleCtx.clip();
    circleCtx.drawImage(image, (image.width - originalSize) / 2, (image.height - originalSize) / 2, originalSize, originalSize, 0, 0, originalSize, originalSize);
  ...
  /**
     ...
     * @param placeholderHueShift Optional hue shift for placeholder images
     * @returns Promise that resolves to an OffscreenCanvas with the blurred image
     */ async PrefetchImage(imageUrl, placeholderHueShift = 0) {
  ...
  /**
    ...
    if (this.container.scene) {
      ...
      this.container.scene.traverse((object)=>{
...
//# sourceMappingURL=DynamicBackground.js.map